...
import com.example.huwenkai.testproject.Adapter.MenuAdapter;
...
import com.example.huwenkai.testproject.Bean.Food;
...
import com.example.huwenkai.testproject.Utils.TimeToDate;
...
public class HomeActivity extends Activity {
    ...
    private void initUI() {
        ...
        rl_unfinish.addItemDecoration(new DividerItemDecoration(getApplicationContext(), DividerItemDecoration.VERTICAL));
        ...
        rl_all.addItemDecoration(new DividerItemDecoration(getApplicationContext(), DividerItemDecoration.VERTICAL));
...
//
            ...
            holder.pelNum.setText(diner + "人" + dataBean.id);
    ...
    public class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                JSONObject food_id = jsonObj.getJSONObject("food_id");
                String s = food_id.toString();
                LogUtils.e(s);
            ...
            //// TODO: 2017-03-20 解析json对象判断是新订单消息还是划菜消息
            //// TODO: 2017-03-16  将消息栏弹出
            tv_massage.setVisibility(View.VISIBLE);
            tv_massage.setText("新订单来了");
